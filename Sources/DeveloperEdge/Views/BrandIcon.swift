...
/// Monochrome brand marks rendered as tintable template NSImages.
/// SVG paths sourced from simple-icons (https://simpleicons.org) — update by searching the
/// site for the brand, copying the SVG path, and replacing the existing entry here.
/// Built once and cached · never recreate per render (avoids flicker).
enum Brand: String {
    ...
    private static let svg: [String: String] = [
        ...
        "linear": #"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="black" d="M0 12.2C.05 18.7 5.33 23.95 11.85 24c6.5-.05 11.78-5.3 11.83-11.8C23.73 5.73 18.47.45 11.97.45 5.47.45.16 5.7 0 12.2zm11.86-9.3c2.73-.01 5.33 1.08 7.24 3.02L3.89 17.08A9.25 9.25 0 0 1 2.5 11.98c0-4.99 4.33-9.11 9.36-9.08zm.23 18.2c-2.66.02-5.22-1.02-7.13-2.89L16.28 6.94a9.26 9.26 0 0 1 2.22 8.33 9.25 9.25 0 0 1-6.41 5.83z"/></svg>"#,
    ]
